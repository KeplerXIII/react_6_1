export default function moveTime(elem, timeZone) {
  // Получаем объект Date в зависимости от выбранного часового пояса
  var date = new Date(new Date().toLocaleString("en-US", { timeZone })),
    hour = date.getHours(),
    min = date.getMinutes(),
    sec = date.getSeconds(),
    hourElt = elem.getElementsByClassName("hour")[0],
    minElt = elem.getElementsByClassName("min")[0],
    secElt = elem.getElementsByClassName("sec")[0],
    digit = elem.getElementsByClassName("digit")[0];
